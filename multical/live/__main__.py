...
def main():
    ...
    parser.add_argument('--auto-capture-role', choices=['training', 'validation'], default='training')
    parser.add_argument('--auto-capture', action='store_true', help='Automatically retain novel stationary poses in the selected role')
